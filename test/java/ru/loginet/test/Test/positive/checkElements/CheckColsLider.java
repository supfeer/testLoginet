 ...
 */
public class CheckColsLider {

    @Test
    public void checkCols() {
        new LoginPage("tf_lider");
        ...
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-Subdivision")).shouldBe(Condition.present);
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-RequestEndDate")).shouldBe(Condition.present);
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-RequestEndTime")).shouldBe(Condition.present);
