 ...
 */
public class CheckColsOkey {

    @Test
    public void checkCols() {
        new LoginPage("test_vopros");
        ShippingRequest shippingRequest = new ShippingRequest("okey");
        ...
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-RequestEndDate")).shouldBe(Condition.present);
        ...
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-VehicleNumber")).shouldBe(Condition.present);
        ...
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-Tonnage")).shouldBe(Condition.present);
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-LoadingPlan")).shouldBe(Condition.present);
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-UnloadingFact")).shouldBe(Condition.present);
        ...
        $(By.className("x-grid3-row-first")).$(By.className("x-grid3-td-DesiredVatIncluded")).shouldBe(Condition.present);
